...
export default function LiveEditPage() {
  ...
  const runConversationTest = async (conversationData: any, config: any) => {
  ...
  const runBatchTest = async () => {
    ...
    for (let i = 0; i < iterations; i++) {
      ...
      // Run all conversations in parallel for speed
      const conversationPromises = testConversations.map(conv => runConversationTest(conv, testConfig));
    ...
    <div className="container mx-auto p-6 max-w-7xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-2 flex-wrap">
                {testPatterns.map((pattern, i) => (
                  <Button
                    key={i}
                    variant="outline"
                    size="sm"
                    onClick={() => setMessage(pattern.message)}
                  >
                    {pattern.type}
                  </Button>
                ))}
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Batch Testing & Review</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <Button 
              ...
              >
                {testing ? 'Running Tests...' : 'Run 8 Conversation Tests'}
              </Button>
