 ...
 * Run: npx ts-node test-undertone-inline.ts
 */

import { UndertoneDetector, UserType } from './src/lib/undertone-detector';
...
const testCases = [
  {
    ...
    expected: UserType.MARRIED_GUILTY,
    minConfidence: 0.7
  },
  {
  ...
  },
  {
    ...
    expected: UserType.LONELY_SINGLE,
    minConfidence: 0.6
  },
  {
    ...
    expected: UserType.HORNY_ADDICT,
    minConfidence: 0.6
  },
  {
    ...
    expected: UserType.CURIOUS_TOURIST,
    minConfidence: 0.5
  }
];
